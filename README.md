...
### hack4lx_Fish  v1.1
### Coded by:M4nifest0 Cyber security team @hack4lx (https://github.com/attakercyebr) .
### UPGRADED BY: Cyber security team @hack4lx
...
### Usage:
```
git clone (https://github.com/attakercyebr/hack4lx_Fish)
cd hack4lx_Fish
bash hack4lx_Fish
```
✂️●●●●●●●●●●●●●●●●●●●●●●●●●●●●
